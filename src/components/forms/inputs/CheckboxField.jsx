...
const Checkbox = ({ initialValue = false, defaultValue=false, field, form, hide = false, hideOn, condition = true, options, checkboxSize = 'lg', inputGroupClassName = 'form-group' }) => {
  ...
  }, [field.value, field.name, initialValue, defaultValue])
