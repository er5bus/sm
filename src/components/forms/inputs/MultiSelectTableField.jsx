  ...
  return (
    <>
      <div className={ inputGroupClassName }>
        ...
        <SearchField applyFilter={({ search }) => setSearchTerm(search) } />
      ...
      <div className={ inputGroupClassName }>
        ...
        <SearchField applyFilter={ (value) => setQueryParams(value) } />
...
export default withRouter(injectIntl(MultiSelectTable))
