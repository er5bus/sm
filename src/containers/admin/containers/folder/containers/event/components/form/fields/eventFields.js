...
import {
  ...
  eventStateUIHelper,
  eventNatureUIHelper,
  eventStatusUIHelper, COLLECTIVE_WORKSHOP_OR_PROJECT_INFORMATION
} from "./../../../../../../../UIHelpers"
...
export const eventFields = _.memoize(({ intl }) => [
  ...
  {
    name: "topicWorkshop",
    label: intl.formatMessage({ id: "FOLDER.INPUT.TOPIC_WORKSHOP" }),
    placeholder: intl.formatMessage({ id: "FOLDER.INPUT.TOPIC_WORKSHOP" }),
    size: 12,
    hide: true,
    hideOn: "nature",
    condition: COLLECTIVE_WORKSHOP_OR_PROJECT_INFORMATION,
  },
  {
    name: "isPresent",
    component: CHECKBOX,
  ...
  {
    name: "causeAbsence",
    label: intl.formatMessage({ id: "FOLDER.INPUT.CAUSE_ABSENCE" }),
    placeholder: intl.formatMessage({ id: "FOLDER.INPUT.CAUSE_ABSENCE" }),
    hide: false,
    showOn: "isPresent",
  },
  {
