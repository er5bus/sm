...
const SkillsEvaluationShow = ({ history, params = null, intl }) => {
  ...
  const { isFetching, skillsEvaluationFolderForShow = null, error } = useSelector(
    (state) => ({
      isFetching: state.admin.skillsEvaluationFolder.isFetching,
      skillsEvaluationFolderForShow: state.admin.skillsEvaluationFolder.skillsEvaluationFolder,
  ...
  return (
    <ShowView
      ...
      error={error}
    >
      <SkillsEvaluation error={error} isFetching={isFetching} skillsEvaluationFolder={skillsEvaluationFolderForShow} />
    </ShowView>
  )
}
