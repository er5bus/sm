        ...
        <OverlayTrigger
          overlay={
            <Tooltip id="partnership-edit-tooltip">
              <FormattedMessage id="SKILL.EDIT" />
            </Tooltip>
          }
        >
          <ProtectedLink rule={formatExtraData.editSkillRule}>
            <a
              className="btn btn-sm btn-icon btn-light btn-hover-warning btn-sm mx-1 my-1"
              onClick={() => formatExtraData.openEditSkillPage(row.id)}
            >
        ...
        <OverlayTrigger
          overlay={
            <Tooltip id="partnership-show-tooltip">
              <FormattedMessage id="SKILL.SHOW" />
            </Tooltip>
          }
        >
          <ProtectedLink rule={formatExtraData.showSkillRule}>
            <a
              className="btn btn-sm btn-icon btn-light btn-hover-primary btn-sm mx-1 my-1"
              onClick={() => formatExtraData.openShowSkillPage(row.id)}
            >
        ...
        <OverlayTrigger
          overlay={
            <Tooltip id="partnership-disable-tooltip">
              <FormattedMessage id="SKILL.DISABLE" />
            </Tooltip>
          }
        >
          <ProtectedLink rule={formatExtraData.disableSkillRule}>
            <a
              className="btn btn-sm btn-icon btn-light btn-hover-danger btn-sm my-1 mx-1"
              onClick={() => formatExtraData.openDisableSkillDialog(row.id)}
            >
        ...
        <OverlayTrigger
          overlay={
            <Tooltip id="partnership-enable-tooltip">
              <FormattedMessage id="SKILL.ENABLE" />
            </Tooltip>
          }
        >
          <ProtectedLink rule={formatExtraData.enableSkillRule}>
            <a
              className="btn btn-sm btn-icon btn-light btn-hover-success btn-sm mx-1 my-1"
              onClick={() => formatExtraData.openEnableSkillDialog(row.id)}
            >
