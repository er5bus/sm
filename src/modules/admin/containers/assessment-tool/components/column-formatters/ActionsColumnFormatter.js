        ...
        <OverlayTrigger
          overlay={
            <Tooltip id="partnership-edit-tooltip">
              <FormattedMessage id="ASSESSMENT_TOOL.EDIT" />
            </Tooltip>
          }
        >
          <ProtectedLink rule={formatExtraData.editAssessmentToolRule}>
            <a
              className="btn btn-sm btn-icon btn-light btn-hover-warning btn-sm mx-1 my-1"
              onClick={() => formatExtraData.openEditAssessmentToolPage(row.id)}
            >
        ...
        <OverlayTrigger
          overlay={
            <Tooltip id="partnership-show-tooltip">
              <FormattedMessage id="ASSESSMENT_TOOL.SHOW" />
            </Tooltip>
          }
        >
          <ProtectedLink rule={formatExtraData.showAssessmentToolRule}>
            <a
              className="btn btn-sm btn-icon btn-light btn-hover-primary btn-sm mx-1 my-1"
              onClick={() => formatExtraData.openShowAssessmentToolPage(row.id)}
            >
        ...
        <OverlayTrigger
          overlay={
            <Tooltip id="partnership-disable-tooltip">
              <FormattedMessage id="ASSESSMENT_TOOL.DISABLE" />
            </Tooltip>
          }
        >
          <ProtectedLink rule={formatExtraData.disableAssessmentToolRule}>
            <a
              className="btn btn-sm btn-icon btn-light btn-hover-danger btn-sm my-1 mx-1"
              onClick={() => formatExtraData.openDisableAssessmentToolDialog(row.id)}
            >
        ...
        <OverlayTrigger
          overlay={
            <Tooltip id="partnership-enable-tooltip">
              <FormattedMessage id="ASSESSMENT_TOOL.ENABLE" />
            </Tooltip>
          }
        >
          <ProtectedLink rule={formatExtraData.enableAssessmentToolRule}>
            <a
              className="btn btn-sm btn-icon btn-light btn-hover-success btn-sm mx-1 my-1"
              onClick={() => formatExtraData.openEnableAssessmentToolDialog(row.id)}
            >
